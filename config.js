...
module.exports = {
  //==========================================- MAIN - CONFIGS -==================================================================
  SESSION_ID: process.env.SESSION_ID || "AG1QxaSJ#c29AYw47h-Gp7BJp7GHVTAoQ4ihlQOV-XTmNNJ5Kyzg",
  // ADD Your Session Id 
  ...
  packname: process.env.packname || "QUEEN YESHU",
  author: process.env.author || "QUEEN YESHU",
  //==========================================- API-CONFIGS -==========================================================
